    ...
    <div className="lg:col-span-2 shadow-sm border-r border-t border-b border-border  overflow-hiddenflex flex-col min-h-[calc(80vh-10rem)] bg-background">
      ...
      {selectedConversation ? (
        ...
        <>
          ...
          <div className="flex w-full px-2 p-2 md:px-8 lg:px-16 rounded-sm overflow-hidden gap-2 lg:gap-5   z-50 bg-amber-50 ">
            <span className="">
              <Image
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto overflow-x-hidden z-10 p-4 space-y-4 min-h-[48vh] md:min-h-[50vh] max-h-[48vh] md:max-h-[50vh]">
              {messages.map((message) => (
                ...
                >
                  <div
                    className={`max-w-xs px-4 py-2 z-10 rounded-lg text-xs md:text-sm  ${
    ...
    Uploading… {message.uploadProgress}%
            ...
            <div className="flex gap-2 items-center">
              {selectedImage && imagePreview ? (
                <div className="flex items-center p-1 border border-border rounded-lg bg-muted/50">
                  <Image
                    width={40}
                    height={40}
                    src={imagePreview}
